            ...
            if outer_frame:
                ...
                if middle_iframe_el:
                    ...
                    if middle_frame:
                        ...
                        try:
                            inner_iframe_el = await middle_frame.wait_for_selector(
                        ...
                        if inner_iframe_el is not None:
                            ...
                            if inner_frame is not None:
                                try:
                                    await inner_frame.wait_for_load_state(
                        ...
                        logger.debug("Perma.cc inner iframe not found; falling back to middle iframe.")
                        await _inline_media_in_frame(middle_frame)
                        return middle_frame

                # Fallback: if middle iframe not found, use the outer iframe content
